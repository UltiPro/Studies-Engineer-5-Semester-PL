...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == NEW_BOOK_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            Snackbar.make(findViewById(R.id.coordinator_layout), getString(R.string.book_added), Snackbar.LENGTH_LONG)
                    .show();
        } else if (requestCode == EDIT_BOOK_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            Book book = bookViewModel.findall().getValue()
                    .get(Integer.parseInt(data.getStringExtra(EditBookActivity.EXTRA_BOOK_KEY)));
            book.setAuthor(data.getStringExtra(EditBookActivity.EXTRA_EDIT_BOOK_AUTHOR));
            book.setTitle(data.getStringExtra(EditBookActivity.EXTRA_EDIT_BOOK_TITLE));
            bookViewModel.update(book);
            Snackbar.make(findViewById(R.id.coordinator_layout), getString(R.string.book_updated), Snackbar.LENGTH_LONG)
                    .show();
        } else {
    ...
    private class BookHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public boolean onLongClick(View view) {
            ...
            Snackbar.make(findViewById(R.id.coordinator_layout), getString(R.string.book_deleted), Snackbar.LENGTH_LONG)
                    .show();
            return true;
        }
    }
