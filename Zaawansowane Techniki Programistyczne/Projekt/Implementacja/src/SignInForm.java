        ...
        private void initComponents() {
                ...
                contentPaneLayout.setHorizontalGroup(
                                contentPaneLayout.createParallelGroup()
                                                .addGroup(GroupLayout.Alignment.TRAILING, contentPaneLayout
                                                                .createSequentialGroup()
                                                                .addComponent(label6, GroupLayout.PREFERRED_SIZE, 339,
                ...
                contentPaneLayout.setVerticalGroup(
                                contentPaneLayout.createParallelGroup()
                                                .addGroup(contentPaneLayout.createSequentialGroup()
                                                                .addGap(36, 36, 36)
                                                                .addComponent(label4, GroupLayout.PREFERRED_SIZE, 43,
                                                                                GroupLayout.PREFERRED_SIZE)
                                                                .addGap(29, 29, 29)
                                                                .addGroup(contentPaneLayout.createParallelGroup(
                                                ...
                                                .addGroup(GroupLayout.Alignment.TRAILING, contentPaneLayout
                                                                ...
                                                                .addComponent(label6, GroupLayout.PREFERRED_SIZE, 408,
                                                                                GroupLayout.PREFERRED_SIZE)));
                pack();
        ...
        public SignInForm(String title) {
                ...
                rejBtn.addActionListener(new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent e) {
                                library.insertUser(nameField.getText(), surnameField.getText(), emailField.getText(),
