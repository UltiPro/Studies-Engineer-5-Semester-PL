    ...
    public ShopForm(String title) {
        ...
        addOrderBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(order.products.isEmpty()){
                    added = true;
                    if(productOrder != null) productOrder.count = 1;
        ...
        setOrderBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                rabat.add(kod);
                int result_dane = JOptionPane.showConfirmDialog(null, rabat, "Write discount code.", JOptionPane.OK_CANCEL_OPTION);
                if(result_dane == JOptionPane.OK_OPTION){
                    ...
                    if(library.findDiscount(kod.getText())){
                        ...
                        JOptionPane.showMessageDialog(null, "Incorrect discount code!", "Error", JOptionPane.ERROR_MESSAGE);                    }
                }
                ...
                int result = JOptionPane.showConfirmDialog(null, myPanel, "Choose kind of bill.", JOptionPane.OK_CANCEL_OPTION);
                ...
                if (result == JOptionPane.OK_OPTION) {
                    ...
                    if(comboBox.getSelectedItem().equals("Invoice for person")){
                        ...
                        dane.add(surname);
                        int result_dane1 = JOptionPane.showConfirmDialog(null, dane, "Choose kind of bill.", JOptionPane.OK_CANCEL_OPTION);
                        if(result == JOptionPane.OK_OPTION){
                    ...
                    if(comboBox.getSelectedItem().equals("Invoice for firm")){
                        ...
                        dane.add(nip);
                        int result_dane2 = JOptionPane.showConfirmDialog(null, dane, "Choose kind of bill.", JOptionPane.OK_CANCEL_OPTION);
                        if(result == JOptionPane.OK_OPTION){
