                        ...
                        panel1Layout.createParallelGroup()
                                .addGroup(panel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(panel1Layout.createParallelGroup()
                                                .addGroup(panel1Layout.createSequentialGroup()
                                                        .addGroup(panel1Layout.createParallelGroup()
                                                                .addComponent(scrollPane6, GroupLayout.DEFAULT_SIZE, 378, Short.MAX_VALUE)
                                                                .addGroup(panel1Layout.createSequentialGroup()
                        ...
                        panel2Layout.createParallelGroup()
                                .addGroup(panel2Layout.createSequentialGroup()
                                        ...
                                        .addGroup(panel2Layout.createParallelGroup()
                                                .addComponent(scrollPane2, GroupLayout.DEFAULT_SIZE, 780, Short.MAX_VALUE)
                                                .addGroup(panel2Layout.createSequentialGroup()
                        ...
                        panel3Layout.createParallelGroup()
                                .addGroup(panel3Layout.createSequentialGroup()
                                        ...
                                        .addGroup(panel3Layout.createParallelGroup()
                                                ...
                                                .addGroup(panel3Layout.createSequentialGroup()
                                                        .addComponent(comboWarehouseSales, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                        .addGap(18, 18, 18)
                                        ...
                                        .addGroup(panel3Layout.createParallelGroup()
                                                .addGroup(panel3Layout.createSequentialGroup()
                                                        .addGroup(panel3Layout.createParallelGroup()
                                                                .addGroup(panel3Layout.createSequentialGroup()
                                                                        .addComponent(comboWarehouse, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                                                        .addGap(0, 250, Short.MAX_VALUE))
                                                                .addComponent(scrollPane4, GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE))
                                                        .addContainerGap())
                                                .addGroup(panel3Layout.createSequentialGroup()
    ...
    public AdminPanelForm(String title){
        ...
        warehouseSaleBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                myPanel.add(xField);
                int result = JOptionPane.showConfirmDialog(null, myPanel, "Write Warehouse Name.", JOptionPane.OK_CANCEL_OPTION);
        ...
        addDepartmentBtn.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                myPanel.add(new JLabel("Name:"));
                myPanel.add(xField);
                int result = JOptionPane.showConfirmDialog(null, myPanel, "Write Department Name.", JOptionPane.OK_CANCEL_OPTION);
                if (result == JOptionPane.OK_OPTION) {
        ...
        addCategoryButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int result = JOptionPane.showConfirmDialog(null, myPanel, "Write Category Name.", JOptionPane.OK_CANCEL_OPTION);
                if (result == JOptionPane.OK_OPTION) {
        ...
        addProductBtn2.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int result = JOptionPane.showConfirmDialog(null, myPanel, "Write Product Data.", JOptionPane.OK_CANCEL_OPTION);
                if (result == JOptionPane.OK_OPTION) {
        ...
        productsList.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                if(e.getClickCount() == 2){
                    ...
                    int result = JOptionPane.showConfirmDialog(null, myPanel, "Product Data.", JOptionPane.OK_CANCEL_OPTION);
                    if (result == JOptionPane.OK_OPTION && product != null) {
                        ...
                        library.updateProduct(index, product.name, product.price, product.idType, product.idWarehouse, product.idOrder, product.count);
                    }
                    refreshProductList();
                }
            }
