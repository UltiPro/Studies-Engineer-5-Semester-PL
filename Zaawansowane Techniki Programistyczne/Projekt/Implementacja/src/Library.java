...
public class Library implements Proxy {
    ...
    public boolean insertInvoiceForPerson(String name, String surname, double price){
        try{
            PreparedStatement preparedStatement = connection.prepareStatement("insert into FakturaNaOsobeFizyczna values (NULL,?,?,?);");
            preparedStatement.setString(1, name);
    ...
    public boolean insertInvoiceForFirm(double NIP, double price) {
        try{
            PreparedStatement preparedStatement = connection.prepareStatement("insert into FakturaNaFirme values (NULL,?,?);");
    ...
    public boolean insertCategory(String name, int idDepartament){
        try{
            PreparedStatement preparedStatement = connection.prepareStatement("insert into Kategoria values (NULL,?,?);");
            preparedStatement.setString(1, name);
    ...
    public boolean insertWarehouseOfComplaint(String name){
        try{
            PreparedStatement preparedStatement = connection.prepareStatement("insert into MagazynReklamacji values (NULL,?);");
            preparedStatement.setString(1, name);
            preparedStatement.execute();
        } catch (SQLException e){
            return false;
    ...
    public boolean deleteWarehouseOfComplaint(String name){
        try{
            PreparedStatement preparedStatement = connection.prepareStatement("delete from MagazynReklamacji where nazwa = ?");
    ...
    public boolean insertWarehouseOfSales(String name){
        try{
            PreparedStatement preparedStatement = connection.prepareStatement("insert into MagazynSprzedazy values (NULL,?);");
            preparedStatement.setString(1, name);
            preparedStatement.execute();
        } catch (SQLException e){
            return false;
    ...
    public boolean deleteWarehouseOfSales(String name){
        try{
            PreparedStatement preparedStatement = connection.prepareStatement("delete from MagazynSprzedazy where nazwa = ?");
            preparedStatement.setString(1, String.valueOf(name));
            preparedStatement.execute();
        } catch (SQLException e){
            e.printStackTrace();
    ...
    public boolean insertProduct(String name, double price, int typeId, int warehouseId, int orderId, int count){
        try{
            PreparedStatement preparedStatement = connection.prepareStatement("insert into Produkt values (NULL,?,?,?,?,?,?);");
            preparedStatement.setString(1, name);
            preparedStatement.setString(2, String.valueOf(price));
    ...
    public boolean updateProduct(int id, String name, double price, int typeId, int warehouseId, int orderId, int count){
        try{
            PreparedStatement preparedStatement = connection.prepareStatement("UPDATE Produkt SET nazwa=?,cena=?,id_typu=?,id_magazynu=?,id_zamowienia=?,ilosc=? WHERE id_produktu = ?");
            preparedStatement.setString(1, name);
            preparedStatement.setString(2, String.valueOf(price));
            preparedStatement.setString(3, String.valueOf(typeId));
            preparedStatement.setString(4, String.valueOf(warehouseId));
    ...
    public boolean insertUser(String name, String surname, String email, String password, int typ){
        try{
            PreparedStatement preparedStatement = connection.prepareStatement("insert into Uzytkownik values (NULL,?,?,?,?,?);");
            preparedStatement.setString(1, name);
            preparedStatement.setString(2, surname);
    ...
    public boolean deleteUser(int id){
        try{
            PreparedStatement preparedStatement = connection.prepareStatement("delete from Uzytkownik where id_uzytkownika = ?");
    ...
    public boolean insertOrder(double toPay, int userId, int receitpId){
        try{
            PreparedStatement preparedStatement = connection.prepareStatement("insert into Zamowienie values (NULL,?,?,?);");
    ...
    public boolean deleteOrder(int id){
        try{
            PreparedStatement preparedStatement = connection.prepareStatement("delete from Zamowienie where id_zamowienia = ?");
            preparedStatement.setString(1, String.valueOf(id));
            preparedStatement.execute();
        } catch (SQLException e){
            e.printStackTrace();
    ...
    public boolean findDiscount(String discount){
        if(discount == "winterSale") return true;
        return false;
    }
