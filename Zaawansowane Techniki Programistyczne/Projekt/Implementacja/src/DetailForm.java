                ...
                contentPaneLayout.createParallelGroup()
                        .addGroup(contentPaneLayout.createSequentialGroup()
                                ...
                                .addGroup(contentPaneLayout.createParallelGroup()
                                        .addComponent(priceLabel, GroupLayout.PREFERRED_SIZE, 133,
                ...
                contentPaneLayout.createParallelGroup()
                        .addGroup(contentPaneLayout.createSequentialGroup()
                                ...
                                .addGroup(contentPaneLayout.createParallelGroup()
                                        ...
                                        .addGroup(contentPaneLayout.createSequentialGroup()
                                                .addComponent(priceLabel, GroupLayout.PREFERRED_SIZE, 32,
                                                        GroupLayout.PREFERRED_SIZE)
                                                .addGap(18, 18, 18)
                                                .addComponent(goBackBtn)
        ...
        for (Product pFromDataBase : library.selectProduct()) {
            for (Product p : ShopForm.order.products) {
                if (pFromDataBase.name.equals(p.name)) {
                    library.updateProduct(pFromDataBase.id, pFromDataBase.name, pFromDataBase.price,
                            pFromDataBase.idType, pFromDataBase.idWarehouse, 0, pFromDataBase.count - p.count);
